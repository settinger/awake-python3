...
class RadioGroup(tkinter.ttk.LabelFrame):
    def __init__(self, parent, text, options, default=None):
        tkinter.ttk.LabelFrame.__init__(self, parent, text=text)
        ...
        for text, value in options:
            radio = tkinter.ttk.Radiobutton(self, text=text, variable=self.var, value=value)
...
class BankSelect(tkinter.ttk.Combobox):
    def __init__(self, parent, proj, includeAny=False):
        ...
        tkinter.ttk.Combobox.__init__(self, parent, state='readonly', textvariable=self.var, values=values, width=10)
